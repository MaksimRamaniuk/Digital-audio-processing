...
xlabel('Samples', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
ylabel('Amplitude', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
title('Output signal by lin conv', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
xlim([0 length(y)]);grid on;
subplot(5,1,4);
plot(y_matlab);
xlabel('Samples', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
ylabel('Amplitude', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
title('Output signal by conv', 'Interpreter', 'latex', 'FontSize', 14, 'FontName', 'Times New Roman');
